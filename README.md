...
Grid is the primary css function used in building the layout to this website, and it was chosen for multiple reasons:
 ...
 <img width ="700" alt ="Font root variables" src ="assets/images/font-root-variables.png">
  ...
  -  The main icons used throughout the website came from [fontawesome.com](https://fontawesome.com/). They supplied the icons for all social media links and the company's contact information. They also supplied the icons used in the confirmation.html page's gear animation.
